...
SYMBOLS = [
    ...
    "FILUSDT","ARBUSDT","NEARUSDT","OPUSDT","INJUSDT",
    "RUNEUSDT","FETUSDT","SUIUSDT","TIAUSDT","SEIUSDT",
    "WLDUSDT","JUPUSDT","STXUSDT","AAVEUSDT","MKRUSDT",
    "SNXUSDT","COMPUSDT","CRVUSDT","LDOUSDT","RNDRUSDT",
    "GRTUSDT","APEUSDT","SANDUSDT","MANAUSDT","AXSUSDT",
    "GALAUSDT","FLOWUSDT","CHZUSDT","ENJUSDT","BATUSDT",
    "ZILUSDT","ONEUSDT","HOTUSDT","VETUSDT","ICPUSDT",
    "ALGOUSDT","EGLDUSDT","XTZUSDT","THETAUSDT","EOSUSDT",
    "KAVAUSDT","BANDUSDT","COTIUSDT","SKLUSDT","CELRUSDT",
    "CKBUSDT","IOSTUSDT","ONTUSDT","NKNUSDT","STMXUSDT",
    "DGBUSDT","SCUSDT","ZENUSDT","ZECUSDT","DASHUSDT",
    "WAVESUSDT","NEOUSDT","QTUMUSDT","ICXUSDT","HBARUSDT",
    "CFXUSDT","MINAUSDT","WOOUSDT","PERPUSDT","DYDXUSDT",
    "GMXUSDT","MAGICUSDT","IDUSDT","BLURUSDT","PENDLEUSDT",
    "CYBERUSDT","ARKMUSDT","AGLDUSDT","BONDUSDT","LPTUSDT",
    "UMAUSDT","TURBOUSDT","GLMRUSDT","AMBUSDT","WUSDT",
]
