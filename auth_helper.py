...
SYMBOLS = {
    "nse_fo": ["NIFTY","BANKNIFTY","FINNIFTY","MIDCPNIFTY","RELIANCE","HDFCBANK","TCS","INFY","ICICIBANK","SBIN","AXISBANK","KOTAKBANK","LT","WIPRO","BAJFINANCE","TITAN","MARUTI","SUNPHARMA","TMPV","ADANIENT","BHARTIARTL","HINDUNILVR","ITC","HCLTECH","ULTRACEMCO","NTPC","ADANIPORTS","ONGC","POWERGRID","M&M","TATASTEEL","ASIANPAINT","COALINDIA","BAJAJFINSV","NESTLEIND","JSWSTEEL","GRASIM","HDFCLIFE","TECHM","BAJAJ-AUTO","DRREDDY","CIPLA","BEL","EICHERMOT","HINDALCO","INDUSINDBK","APOLLOHOSP","BRITANNIA","SBILIFE","HEROMOTOCO","SHRIRAMFIN","TRENT","JIOFIN","ETERNAL"],
    "mcx_fo": ["GOLDM","SILVERM","CRUDEOIL","NATURALGAS","COPPER"],
}
STOCK_SET  = {"RELIANCE","HDFCBANK","TCS","INFY","ICICIBANK","SBIN","AXISBANK","KOTAKBANK","LT","WIPRO","BAJFINANCE","TITAN","MARUTI","SUNPHARMA","TMPV","ADANIENT","BHARTIARTL","HINDUNILVR","ITC","HCLTECH","ULTRACEMCO","NTPC","ADANIPORTS","ONGC","POWERGRID","M&M","TATASTEEL","ASIANPAINT","COALINDIA","BAJAJFINSV","NESTLEIND","JSWSTEEL","GRASIM","HDFCLIFE","TECHM","BAJAJ-AUTO","DRREDDY","CIPLA","BEL","EICHERMOT","HINDALCO","INDUSINDBK","APOLLOHOSP","BRITANNIA","SBILIFE","HEROMOTOCO","SHRIRAMFIN","TRENT","JIOFIN","ETERNAL"}
...
STEPS = {
    ...
    "TITAN":50,"MARUTI":100,"SUNPHARMA":20,"TMPV":10,"ADANIENT":50,
